...
static void client_thread(void *args, zctx_t *ctx, void *pipe) {
...
static void server_thread(void *args, zctx_t *ctx, void *pipe) {
...
int main(void) {
  ...
  void *client = zthread_fork(ctx, client_thread, NULL);
