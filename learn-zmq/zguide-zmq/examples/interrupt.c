...
//  Signal handling
//
//  Create a self-pipe and call s_catch_signals(pipe's writefd) in your
//  application at startup, and then exit your main loop if your pipe contains
//  any data. Works especially well with zmq_poll.
...
int main(void) {
  ...
  zmq_pollitem_t items[] = {{0, pipefds[0], ZMQ_POLLIN, 0},
